...
type UserEdges struct {
	...
	// Studytimes holds the value of the studytimes edge.
	Studytimes []*StudyTime `json:"studytimes,omitempty"`
...
// StudytimesOrErr returns the Studytimes value or an error if the edge
// was not loaded in eager-loading.
func (e UserEdges) StudytimesOrErr() ([]*StudyTime, error) {
	if e.loadedTypes[1] {
		return e.Studytimes, nil
	}
	return nil, &NotLoadedError{edge: "studytimes"}
}
...
// QueryStudytimes queries the "studytimes" edge of the User entity.
func (u *User) QueryStudytimes() *StudyTimeQuery {
	return NewUserClient(u.config).QueryStudytimes(u)
}
